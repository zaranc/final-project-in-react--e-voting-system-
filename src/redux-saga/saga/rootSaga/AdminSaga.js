...
import { ADD_CONNECTION_PENDING, ADD_ELECTION_PENDING, ADD_PARTY_PENDING, ADD_USER_PENDING, ADD_VOTE_PENDING, DELETE_USER_PENDING, GET_ALL_CONNECTION_PENDING, GET_ALL_ELECTION_PENDING, GET_ALL_PARTY_PENDING, GET_ALL_USER_PENDING, GET_ALL_VOTE_PENDING } from "../../admin/action/Action";
import { handle_DELETE_USER, handle_add_connection_data, handle_add_election_data, handle_add_party_data, handle_add_user_data, handle_add_vote_data, handle_get_connection_data, handle_get_election_data, handle_get_party_data, handle_get_user_data, handle_get_vote_data } from "../Admin/ManageAdmin";
